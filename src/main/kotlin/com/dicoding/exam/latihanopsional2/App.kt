...
fun minAndMax(number: Int): Int {
    ...
    var minNumber = 9 // angka terbesar pertama kali adalah 9
    var maxNumber = 0 // angka terbesar pertama kali adalah 0

    /*  MENENTUKAN ANGKA TERKECIL
    *   mengambil digit satu persatu mulai dari paling belakang
    *   lalu membandingkannya dengan nilai terkecil saat ini
    */
    ...
    *   mengambil digit satu persatu mulai dari paling belakang
    *   lalu membandingkannya dengan nilai terbesar saat ini
    */
    while (temporaryNumber > 0) {
        val digit = temporaryNumber % 10
        if (digit > maxNumber) {
